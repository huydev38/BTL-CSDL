		...
		<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						<label for="">ID</label>
						<textarea required name="id" id="id" cols="30" rows="2" class="form-control"><?php echo isset($id) ? $id : '' ?></textarea>
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						...
						<textarea required name="plane_no" id="" cols="30" rows="2" class="form-control"><?php echo isset($plane_no) ? $plane_no : '' ?></textarea>
					</div>
				</div>
			</div>
