			...
			<form action="" id="manage-airports">
				<div class="card">
					...
					<div class="form-group">
								...
								<textarea required name="id" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Airport</label>
								<textarea required name="airport" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Location</label>
								<textarea required name="location" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
...
<script>
	...
	$('.delete_airline').click(function(){
		...
		_conf("Are you sure to delete this airport?","delete_airline",[$(this).attr('data-id')])
	})
